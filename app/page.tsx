    ...
    <main className="min-h-screen bg-white">
      ...
      <section id="produtos" className="pt-16 pb-28 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Multifocais (MEIO - CINZA DESTAQUE) */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4"><div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600"><Phone className="w-5 h-5" /></div><div><p className="text-sm text-slate-500 font-bold uppercase">Telefone</p><p className="text-lg font-bold text-slate-900">43-3325-0600</p></div></div>
              <div className="flex items-center gap-4"><div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600"><Mail className="w-5 h-5" /></div><div><p className="text-sm text-slate-500 font-bold uppercase">E-mail</p><p className="text-lg font-bold text-slate-900">contato@lenteshayamax.com.br</p></div></div>
            </div>
          </div>
          <div className="bg-slate-50 p-8 md:p-10 rounded-[2rem] border border-slate-100 shadow-xl">
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2"><label htmlFor="nome" className="text-sm font-bold text-slate-700">Nome</label><Input id="nome" name="nome" placeholder="Seu nome" required className="bg-white" /></div>
                <div className="space-y-2"><label htmlFor="telefone" className="text-sm font-bold text-slate-700">Telefone</label><Input id="telefone" name="telefone" placeholder="(00) 00000-0000" required className="bg-white" /></div>
              </div>
              <div className="space-y-2"><label htmlFor="email" className="text-sm font-bold text-slate-700">E-mail</label><Input id="email" name="email" type="email" placeholder="seu@email.com" required className="bg-white" /></div>
              <div className="space-y-2"><label htmlFor="mensagem" className="text-sm font-bold text-slate-700">Mensagem</label><Textarea id="mensagem" name="mensagem" placeholder="Como podemos ajudar?" required className="bg-white h-32" /></div>
              <div className="pt-2">
